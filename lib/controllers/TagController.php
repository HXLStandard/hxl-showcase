...
class TagController extends AbstractController {
  ...
  function doGET(HttpRequest $request, HttpResponse $response) {
    ...
    $tag = $this->doQuery('select * from tag where tag=?', $tag_tag)->fetch();
    ...
    $imports = $this->doQuery("select distinct I.* $frag", $tag_tag);
    $dataset_count = $this->doQuery("select count(distinct I.*) $frag", $tag_tag)->fetchColumn();;
