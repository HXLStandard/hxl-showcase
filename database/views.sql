...
select R.*, I.stamp, D.ident as dataset_ident, D.name as dataset_name
from row R
join import I on R.import=I.id
join dataset D on I.dataset=D.id;

create or replace view value_view as
select V.*, C.header, I.stamp, D.ident as dataset_ident, D.name as dataset_name, CD.code as code_code, CD.name as code_name
from value V
